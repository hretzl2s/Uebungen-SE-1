package org.hbrs.se1.ws22.uebung10.Aufgabe1.Test;

import org.hbrs.se1.ws22.uebung10.Aufgabe1.control.BoundingBoxFactory;
import org.hbrs.se1.ws22.uebung10.Aufgabe1.control.MyPoint;
import org.hbrs.se1.ws22.uebung10.Aufgabe1.control.MyPrettyRectangle;
...
public class MyPrettyRectangleTest {
    ...
    public void testGetArea(){
        ...
        //
        // [ihr Code]
        assertEquals(6, left.getArea(), 0.0f);
        assertEquals(12, right.getArea(), 0.0f);
        assertEquals(1, middle.getArea(), 0.0f);
        assertEquals(3, somewhere.getArea(), 0.0f);
    }
    ...
    public void testGetPerimeter(){
        ...
        //
        // [ihr Code]
        assertEquals(10, left.getPerimeter(), 0.0f);
        assertEquals(14, right.getPerimeter(), 0.0f);
        assertEquals(4, middle.getPerimeter(), 0.0f);
        assertEquals(8, somewhere.getPerimeter(), 0.0f);
    }
    ...
    public void testSameIdentity() {
        ...
        // [ihr Code]
        assertSame(true, left.equals(other));
        assertSame(false, left.equals(right));
        assertSame(false, left.equals(middle));
        assertSame(true, left.equals(left));
        assertSame(false, left.equals(somewhere));
    ...
    public void testGetBoundingBox( ) {
        ...
        //
        // [ihr Code]
        MyPrettyRectangle bbox = BoundingBoxFactory.createBoundingBox(rect);
        MyPrettyRectangle expectedBox = new MyPrettyRectangle(1.0,0.0,6.0,4.0);
        assertEquals(expectedBox, bbox);
